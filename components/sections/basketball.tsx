...
import { Calendar, Trophy, ShoppingCart, Check } from "lucide-react"
...
export function BasketballSection({ pricing, videos }: { pricing: Pricing[]; videos: Video[] }) {
  ...
  return (
    <section id="basketball" className="py-24 sm:py-32 bg-card/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-sm font-medium tracking-widest uppercase text-muted-foreground">On the Court</h2>
            <div className="h-px flex-1 bg-border" />
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 text-primary">
                ...
                <span className="text-lg font-semibold text-foreground">Basketball</span>
              </div>
              <p className="text-muted-foreground leading-relaxed">
                Current D2 starter · Private shooting and guard training available. Two-time Virginia HS 3-point record
                holder with a proven track record of elite marksmanship.
              </p>
